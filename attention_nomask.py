...
class DecoderLayer(tfl.Layer):
    def __init__(self, output_dim, d_model, heads, dropout):
        super().__init__()
        self.mha1 = tfl.MultiHeadAttention(num_heads=heads, key_dim=d_model // heads, dropout=dropout)
        self.layer_norm1 = tfl.LayerNormalization(epsilon=1e-6)
        self.mha2 = tfl.MultiHeadAttention(num_heads=heads, key_dim=d_model // heads, dropout=dropout)
        self.layer_norm2 = tfl.LayerNormalization(epsilon=1e-6)
